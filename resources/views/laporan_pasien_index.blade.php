...
<main class="container">
  ...
  <div class="row mb-2">
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-primary-emphasis">Ta'aruf</strong>
          <h3 class="mb-0">Apa yaa?</h3>
          <div class="mb-1 text-body-secondary">Nov 12</div>
          <p class="card-text mb-auto">Yuk berkenalan dengan UKMI dalam kegiatan Puskominfosis</p>
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-success-emphasis">Kepengurusan</strong>
          <h3 class="mb-0">Muktamar XXII</h3>
          <div class="mb-1 text-body-secondary">Nov 11</div>
          <p class="mb-auto">Penyelenggaraan Muktamar yang ke XXII UKMI Ar-Ruhul Jadid.</p>
          <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
            Continue reading
            <svg class="bi"><use xlink:href="#chevron-right"/></svg>
          </a>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      <h1 class="display-5 pb-4 mb-1 fst-italic border-bottom" style="text-align: center">
        خَبَرٌ
      </h1>

      <article class="blog-post">
        <h2 class="display-5 link-body-emphasis mb-1">DDO 2024</h2>
        <p class="blog-post-meta">17 Desember, 2024 by <a href="#">Dani</a></p>

        <p>Pada awal Desember, Alhamdulillah UKMI Ar-RUhul Jadid berhasil menyelenggarakan kegiatan DDO 2024</p>
        <hr>
    ...
    <div class="col-md-4">
      <div class="position-sticky" style="top: 2rem;">
        <div class="p-4 mb-3 bg-body-tertiary rounded">
          ...
          <p class="mb-0">Media Sosial kami : .</p>
        </div>
